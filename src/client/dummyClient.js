...
import { PACKET_TYPE, PACKET_TYPE_LENGTH, VERSION_LENGTH } from "../constants/header.js";
...
class Client {
            ...
            this.clientSocket.on("data", (data) => {
                ...
                switch (packetType) {
                    case PACKET_TYPE.LOGIN_RESPONSE:
                        this.sequence++;
                        setTimeout(() => {
                            const matchReqPacket = CreatePacket(PACKET_TYPE.MATCH_REQUEST, "1.0.0", this.sequence, {});
                    ...
                    case PACKET_TYPE.MATCH_START_NOTIFICATION:
                        ...
                        setInterval(() => {
                            ...
                            const monsterSpwanPacket = CreatePacket(PACKET_TYPE.SPAWN_MONSTER_REQUEST, "1.0.0",this.sequence,{});
    ...
    RegisterStart() {
        ...
        const dummyRegistPacket = CreatePacket(PACKET_TYPE.REGISTER_REQUEST, "1.0.0", 1, dummyclientRegisterPayload);
    ...
    LoginStart() {
        ...
        const dummyLoginPacket = CreatePacket(PACKET_TYPE.LOGIN_REQUEST, "1.0.0", 1, dummyClientLoginPayload);
